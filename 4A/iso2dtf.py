...
class Visualization(object):
	...
	def __init__(self, args):
		...
		self.gminSlider.GetPoint1Coordinate().SetValue(0.01, 0.6)
		...
		self.gmaxSlider.GetPoint1Coordinate().SetValue(0.01, 0.5)
		...
		isovalueSlider.GetPoint1Coordinate().SetValue(0.01, 0.4)
